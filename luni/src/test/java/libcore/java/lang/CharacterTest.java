...
public class CharacterTest extends junit.framework.TestCase {
  ...
  public void test_isWhitespace_180e() {
    // Since Java 11, Mongolian vowel separator is not considered whitespace.
    // http://b/486153102
    assertFalse(Character.isWhitespace(0x180e));
    assertFalse(Character.isSpaceChar(0x180e));
  }
