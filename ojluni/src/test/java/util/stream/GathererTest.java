...
public class GathererTest {
    ...
    @Test
    public void TestPropagateSizeInformation() {
        mustNotPropagateSizeInformation(true);
        mustNotPropagateSizeInformation(false);
    }

    private void mustNotPropagateSizeInformation(boolean parallel) {
        ...
        var result = StreamSupport.stream(s, parallel)
                                  .gather(
                                      Gatherer.of(
      // Android-changed: TODO: Remove this patch when unnamed variable is supported.
                                          // (_, i, d)
                                          (state, i, d)
                                              -> d.push(i) && false
                                      )
