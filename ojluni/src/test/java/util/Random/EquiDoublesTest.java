...
public class EquiDoublesTest {
    ...
    // BEGIN Android-changed: Use explicit DataProviders instead of JUnit5 Arguments
    /*
    ...
    */
    ...
    @DataProvider(name = "equi")
    public static Object[][] equi() {
        return new Object[][]{
                {0.0, 1e-9},
                {1.0, 1.1},
                {1.0e23, 1.1e23},
    ...
    // END Android-changed: Use explicit DataProviders instead of JUnit5 Arguments

    // @ParameterizedTest
    // @MethodSource
    @Test(dataProvider = "equi")
    public void equi(double l, double r) {
    ...
    */
    ...
    @DataProvider(name = "tight")
    public static Object[][] tight() {
        return new Object[][]{
                {0.0, (short) 100},
                {1.0, (short) 100},
                {1.1, (short) 100},
                ...
                {-1.2, (short) 100},
                {-1.2e-30, (short) 100},
                {-Double.MIN_VALUE, (short) 100},
                {-Double.MIN_VALUE, (short) 2},
                {-Double.MAX_VALUE, (short) 2},
        };
    }
    // END Android-changed: Use explicit DataProviders instead of JUnit5 Arguments
    ...
    // @ParameterizedTest
    // @MethodSource
    @Test(dataProvider = "tight")
    public void tight(double l, short steps) {
    ...
    */
    ...
    @DataProvider(name = "tightWithIrregularSpacing")
    public static Object[][] tightWithIrregularSpacing() {
        return new Object[][]{
                {0x1p-1, (short) 15, (short) 23},
                {0x1p0, (short) 17, (short) 5},
                {0x1p1, (short) 7, (short) 8},
                {0x1p-600, (short) 28, (short) 33},
                {0x1p600, (short) 9, (short) 19},
        };
    }
    // END Android-changed: Use explicit DataProviders instead of JUnit5 Arguments
    ...
    // @ParameterizedTest
    // @MethodSource
    @Test(dataProvider = "tightWithIrregularSpacing")
    public void tightWithIrregularSpacing(double m, short lSteps, short rSteps) {
    ...
    */
    ...
    public static Object[][] empty() {
        return new Object[][]{
                ...
                {-1.0},
                {0.0},
                {nextDown(Double.MAX_VALUE, 1)},
                {nextUp(-Double.MAX_VALUE, 1)},
        };
    }
    // END Android-changed: Use explicit DataProviders instead of JUnit5 Arguments
