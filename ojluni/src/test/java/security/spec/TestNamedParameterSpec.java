...
public class TestNamedParameterSpec {
    ...
    // BEGIN Android-changed: Modify the EXPECTED list accordingly with the existing constants.
    /*
    ...
    */
    // END Android-changed: Modify the EXPECTED list accordingly with the existing constants.
    private static String[] EXPECTED = {
            "ED25519", "ED448", "X25519", "X448", "ML_DSA_65", "ML_DSA_87",
    };
