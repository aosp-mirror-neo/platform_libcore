...
public abstract class DynamicConstantDesc<T>
    ...
    public String constantName() { return null; }

    public ClassDesc constantType() { return null; }

    public DirectMethodHandleDesc bootstrapMethod() { return null; }

    public ConstantDesc[] bootstrapArgs() { return null; }

    public List<ConstantDesc> bootstrapArgsList() { return null; }
