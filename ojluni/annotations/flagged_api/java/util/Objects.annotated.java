...
public static long checkFromIndexSize(long fromIndex, long size, long length) { throw new RuntimeException("Stub!"); }

public static int checkFromToIndex(int fromIndex, int toIndex, int length) { throw new RuntimeException("Stub!"); }

public static long checkFromToIndex(long fromIndex, long toIndex, long length) { throw new RuntimeException("Stub!"); }

public static int checkIndex(int index, int length) { throw new RuntimeException("Stub!"); }

public static long checkIndex(long index, long length) { throw new RuntimeException("Stub!"); }
...
public static <T> T requireNonNullElse(T obj, T defaultObj) { throw new RuntimeException("Stub!"); }
